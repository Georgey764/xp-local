...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-accent selection:text-black antialiased">
      <HeaderNavigation />

      {/* Hero Section */}
      <section className="relative pt-32 pb-20 lg:pt-52 lg:pb-40 overflow-hidden">
        {/* Aesthetic Background Blobs using Theme Colors */}
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <button className="w-full sm:w-auto px-10 py-5 bg-background text-foreground font-black rounded-[2rem] border-2 border-neutral-200 hover:border-accent transition-all flex items-center justify-center gap-2">
                The ROI Case Study
              </button>
            </div>
          </div>
      ...
      {/* Social Proof / Stats Section - Using neutral-50 for subtle depth */}
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
            <div className="max-w-xl">
              <h2 className="text-4xl lg:text-5xl font-black mb-6 tracking-tight leading-none text-neutral-950">
                Stop guessing. <br />
                Start gamifying.
              </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {features.map((feature, idx) => (
              <div
                key={idx}
                className="group p-10 rounded-[3rem] bg-neutral-50 border border-transparent hover:border-accent hover:bg-background hover:shadow-2xl transition-all cursor-default"
              >
                <div className="w-16 h-16 bg-background rounded-2xl flex items-center justify-center shadow-sm mb-8 group-hover:scale-110 group-hover:-rotate-3 transition-transform">
                  {feature.icon}
                </div>
                <h3 className="text-2xl font-black mb-4 text-neutral-900">
                  {feature.title}
                </h3>
      ...
      {/* Value Prop Section - Using neutral-800 for high-impact dark contrast */}
      <section className="py-24 bg-neutral-800 text-neutral-50 rounded-[3rem] lg:rounded-[5rem] mx-4 lg:mx-8 mb-20 overflow-hidden relative">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-10 relative z-10">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="relative flex justify-center scale-90 lg:scale-100">
              {/* Mobile Phone Mockup - Using neutral-900 and 950 */}
              <div className="relative w-72 h-[500px] bg-neutral-950 rounded-[3rem] border-8 border-neutral-900 shadow-2xl overflow-hidden ring-1 ring-white/10">
                <div className="h-full w-full bg-neutral-50 flex flex-col">
                  ...
                  <div className="p-6 flex-1">
                    <div className="mb-6">
                      <p className="text-xs font-bold text-neutral-200 mb-2 uppercase tracking-wide">
                        Rewards Progress
                      </p>
                    ...
                    <div className="space-y-4 text-neutral-950">
                      ...
                      <div className="p-4 bg-background rounded-2xl flex items-center justify-between border border-neutral-200 shadow-sm">
              ...
              {/* Floaties using reward and accent */}
              ...
              <div className="absolute bottom-10 -left-10 bg-accent p-3 rounded-xl shadow-lg transform -rotate-6">
                <Star className="text-neutral-950 fill-current" size={20} />
              </div>
            </div>
          </div>
        </div>
      ...
      <footer className="py-20 bg-background border-t border-neutral-100">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="mt-16 pt-8 border-t border-neutral-100 text-center text-neutral-200 text-xs font-bold uppercase tracking-[0.2em]">
